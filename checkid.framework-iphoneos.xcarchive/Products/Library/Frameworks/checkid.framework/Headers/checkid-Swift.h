...
#ifndef CHECKID_SWIFT_H
#define CHECKID_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="checkid",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC7checkid3API")
...
@class UIStackView;
SWIFT_CLASS_NAMED("ScanFaceCustomView") SWIFT_AVAILABILITY(ios,introduced=13.0)
@interface ScanFaceCustomView : UIView
@property (nonatomic, weak) IBOutlet UIStackView * _Null_unspecified centerAlertView;
...
SWIFT_AVAILABILITY(ios,introduced=13.0)
@interface ScanFaceCustomView (SWIFT_EXTENSION(checkid)) <AVCaptureVideoDataOutputSampleBufferDelegate>
- (void)captureOutput:(AVCaptureOutput * _Nonnull)output didOutputSampleBuffer:(CMSampleBufferRef _Nonnull)sampleBuffer fromConnection:(AVCaptureConnection * _Nonnull)connection;
@end

SWIFT_CLASS_NAMED("ScanFaceCustomViewOffline") SWIFT_AVAILABILITY(ios,introduced=13.0)
@interface ScanFaceCustomViewOffline : UIView
@property (nonatomic, weak) IBOutlet UIStackView * _Null_unspecified centerAlertView;
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified cameraView;
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
...
SWIFT_AVAILABILITY(ios,introduced=13.0)
@interface ScanFaceCustomViewOffline (SWIFT_EXTENSION(checkid)) <AVCaptureVideoDataOutputSampleBufferDelegate>
- (void)captureOutput:(AVCaptureOutput * _Nonnull)output didOutputSampleBuffer:(CMSampleBufferRef _Nonnull)sampleBuffer fromConnection:(AVCaptureConnection * _Nonnull)connection;
@end

@class NSString;
@class NSBundle;
SWIFT_CLASS("_TtC7checkid22ScanFaceViewController") SWIFT_AVAILABILITY(ios,introduced=13.0)
@interface ScanFaceViewController : UIViewController
- (void)viewDidLoad;
...
SWIFT_AVAILABILITY(ios,introduced=13.0)
@interface ScanFaceViewController (SWIFT_EXTENSION(checkid)) <AVCaptureVideoDataOutputSampleBufferDelegate>
- (void)captureOutput:(AVCaptureOutput * _Nonnull)output didOutputSampleBuffer:(CMSampleBufferRef _Nonnull)sampleBuffer fromConnection:(AVCaptureConnection * _Nonnull)connection;
@end
...
SWIFT_CLASS("_TtC7checkid18TestViewController")
